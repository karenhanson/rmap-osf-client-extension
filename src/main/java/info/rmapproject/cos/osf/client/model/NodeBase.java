...
public abstract class NodeBase {
    ...
    @Relationship(value = "files", resolve = true, relType = RelType.RELATED, strategy = ResolutionStrategy.REF)
    ...
    @Relationship(value = "license", resolve = true, relType = RelType.RELATED, strategy = ResolutionStrategy.REF)
    @OwlProperty(OwlProperties.OSF_HAS_LICENSE)
    private String license;

    @Relationship(value = "wikis", resolve = true, relType = RelType.RELATED, strategy = ResolutionStrategy.REF)
     ...
     * @param wikis
     */
    public void setWikis(final String wikis) {
        this.wikis = wikis;
    }
