 ...
 */
public class OsfUserApiIterator extends OsfApiIterator<LightUser>{
    
    /** The list of User IDs. */
    private ResourceList<LightUser> ids = null;
	 ...
	 */
	public OsfUserApiIterator(Map<String, String> params) {
    	super(params);
    	//load first batch
    	loadBatch(); 
	}
	...
	protected void loadBatch() {
		...
		try {
    		...
    		ids =(ResourceList<LightUser>) osfClient.getUserIds(params);
